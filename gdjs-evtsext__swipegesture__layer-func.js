...
gdjs.evtsExt__SwipeGesture__Layer.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = eventsFunctionContext.sceneVariablesForExtension.getFromIndex(11).getAsString();}
}
