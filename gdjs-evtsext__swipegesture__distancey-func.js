...
gdjs.evtsExt__SwipeGesture__DistanceY.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = eventsFunctionContext.sceneVariablesForExtension.getFromIndex(8).getAsNumber();}
}
