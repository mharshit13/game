...
gdjs.evtsExt__SwipeGesture__IsSwipeInProgress.idToCallbackMap = new Map();
...
{isConditionTrue_0 = eventsFunctionContext.sceneVariablesForExtension.getFromIndex(3).getAsBoolean();
}
