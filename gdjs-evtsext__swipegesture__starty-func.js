...
gdjs.evtsExt__SwipeGesture__StartY.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).getAsNumber();}
}
