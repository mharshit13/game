...
gdjs.evtsExt__SwipeGesture__SetLayer.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(11).setString(eventsFunctionContext.getArgument("Value"));
}
}
