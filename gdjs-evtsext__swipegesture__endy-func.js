...
gdjs.evtsExt__SwipeGesture__EndY.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = eventsFunctionContext.sceneVariablesForExtension.getFromIndex(2).getAsNumber();}
}
